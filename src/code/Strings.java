...
public class Strings {
	...
	private static final String STYLE = "<p style='font-family:Arial;font-size:18pt'>";
	private static final String END = "</p>";
	
	public static final String PRACTICE_PREDICTABLE_STARTING = STYLE + "In this section of the experiment, the character pair <u>will always begin in the top left square and rotate in a clockwise order.</u><br><br>You will be given a short block of practice trials. Press the Enter key when you are ready to begin." + END; 
	
	public static final String PRACTICE_RANDOM_STARTING = STYLE + "In this section of the experiment, the character pair <u>will always appear in one of the squares randomly.</u><br><br>You will be given a short block of practice trials. Press the Enter key when you are ready to begin." + END;
